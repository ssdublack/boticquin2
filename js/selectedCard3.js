...
function toggleCard(clickedElement) {
    ...
    switch (clickedElement.id) {
        case 'card__grade1':
            updateStars('star1', 'fa-solid fa-star active', '#ff7ab6');
        ...
        case 'card__grade2':
            updateStars('star1', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star2', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star3', 'fa-regular fa-star', '#7e7e7e');
            updateStars('star4', 'fa-regular fa-star', '#7e7e7e');
            updateStars('star5', 'fa-regular fa-star', '#7e7e7e');
            break;
        case 'card__grade3':
            updateStars('star1', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star2', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star3', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star4', 'fa-regular fa-star', '#7e7e7e');
            updateStars('star5', 'fa-regular fa-star', '#7e7e7e');
            break;
        case 'card__grade4':
            ...
            updateStars('star2', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star3', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star4', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star5', 'fa-regular fa-star', '#7e7e7e');
            break;
        case 'card__grade5':
            updateStars('star1', 'fa-solid fa-star active', '#ff7ab6');
            ...
            updateStars('star3', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star4', 'fa-solid fa-star active', '#ff7ab6');
            updateStars('star5', 'fa-solid fa-star active', '#ff7ab6');
            break;
